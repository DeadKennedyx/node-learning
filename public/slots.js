    ...
    $.jSlots = function(el, options){
        ...
        base.checkWinner = function(endNum, slot) {
            ...
            if (base.doneCount === base.options.number) {
                ...
                if(base.allSlots[0].number == base.allSlots[1].number && base.allSlots[0].number == base.allSlots[2].number){
                  base.winCount++;
                  base.winLetter = finalNumbers[0];
                ...
                if ( base.winCount && $.isFunction(base.options.onWin) ) {
                    base.options.onWin(base.winCount, base.winners, base.winLetter, finalNumbers);
                }
                base.isSpinning = false;
            }
        };
